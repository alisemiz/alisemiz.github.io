...
function highlightNavOnScroll() {
  ...
  // Eğer en üstteyse veya hiçbir section aktif değilse, Hakkımda'yı aktif yapabiliriz (opsiyonel)
  // Veya hiçbirini aktif yapmayabiliriz
  // Eğer en üstteyse hiçbirini aktif yapma:
